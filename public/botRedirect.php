...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    {
        if (TawSlack::getChannelInfo($channel_id) != false || TawSlack::getGroupInfo($channel_id) != false)
        {
        ...
        {
            echo "You must be into a public channel to use this. _(or a private channel where AlephRo also happens to be)_";
        }
    }
    else
    {
